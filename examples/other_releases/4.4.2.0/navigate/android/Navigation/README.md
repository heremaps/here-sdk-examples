The Navigation example app shows how to calculate a route from A to B and how to start turn-by-turn navigation with voice commands. You can find how this is done in [NavigationExample.java](app/src/main/java/com/here/tracking/NavigationExample.java). It also shows how to set a tracking view [tracking view](app/src/main/java/com/here/tracking/TrackingExample.java)
