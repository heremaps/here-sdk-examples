The Traffic example app shows how to toggle traffic flow and traffic incidents visualization. You can find how this is done in [TrafficExample.java](app/src/main/java/com/here/traffic/TrafficExample.java).
