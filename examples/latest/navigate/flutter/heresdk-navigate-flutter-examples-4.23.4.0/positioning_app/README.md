The positioning example app shows how to retrieve and show your current location on the map. You can find how this is done in [PositioningExample.dart](lib/PositioningExample.dart).
