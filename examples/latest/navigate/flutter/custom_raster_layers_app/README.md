This example app shows how to load custom raster layers. You can find how this is done in [CustomRasterLayersExample.dart](lib/CustomRasterLayersExample.dart).
