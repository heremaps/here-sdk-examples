The Gesture example app shows how to handle common map gestures, for example, double tap to zoom in. You can find how this is done in [GesturesExample.dart](lib/GesturesExample.dart).
