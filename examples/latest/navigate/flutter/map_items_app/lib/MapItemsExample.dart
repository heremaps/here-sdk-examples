...
class MapItemsExample {
  ...
  void registerCustomFont() {
    ...
    String fontFileName = "assets/fonts/SimpleSans.ttf";
  ...
  Future<void> showMapMarkerWithText() async {
    ...
    try {
      textStyleNew = MapMarkerTextStyle.withFont(
        ...
        placements,
        "SimpleSans"  // The font name as registered via assetsManager.registerFont above. If an empty string is provided or the asses is not found, a default font will be used.
      );
