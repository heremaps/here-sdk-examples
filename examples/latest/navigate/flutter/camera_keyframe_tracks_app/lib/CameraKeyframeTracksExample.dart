...
class CameraKeyframeTracksExample {
  ...
  void startTripToNYC() {
    ...
    _hereMapController.camera.startAnimationWithListener(
      mapCameraAnimation,
      AnimationListener((AnimationState animationState) {
  ...
  List<MapCameraKeyframeTrack>? _createMapCameraKeyframeTracks() {
    ...
    try {
      geoCoordinatesMapCameraKeyframeTrack = MapCameraKeyframeTrack.lookAtTargetWithEasing(
      ...
      geoOrientationMapCameraKeyframeTrack = MapCameraKeyframeTrack.lookAtOrientationWithEasing(
