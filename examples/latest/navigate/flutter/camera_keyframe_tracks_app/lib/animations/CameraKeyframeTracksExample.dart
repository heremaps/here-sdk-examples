...
class CameraKeyframeTracksExample {
  ...
  List<LocationKeyframeModel> _createLocationsForTripToNYC() {
    ...
    locationList.addAll([
      LocationKeyframeModel(
          GeoCoordinates(40.685869754854544, -74.02550202768754), const Duration(milliseconds: 0)), // Statue of Liberty
      LocationKeyframeModel(GeoCoordinates(40.69051652745291, -74.04455943649657),
          const Duration(milliseconds: 5000)), // Statue of Liberty
      LocationKeyframeModel(GeoCoordinates(40.69051652745291, -74.04455943649657),
          const Duration(milliseconds: 7000)), // Statue of Liberty
      LocationKeyframeModel(GeoCoordinates(40.69051652745291, -74.04455943649657),
          const Duration(milliseconds: 9000)), // Statue of Liberty
      LocationKeyframeModel(
          GeoCoordinates(40.690266839135, -74.01237515471776), const Duration(milliseconds: 5000)), // Governor Island
      LocationKeyframeModel(GeoCoordinates(40.7116777285189, -74.01248494562448),
          const Duration(milliseconds: 6000)), // World Trade Center
      LocationKeyframeModel(GeoCoordinates(40.71083291395444, -74.01226399217569),
          const Duration(milliseconds: 6000)), // World Trade Center
      LocationKeyframeModel(GeoCoordinates(40.719259512385506, -74.01171007254635),
          const Duration(milliseconds: 5000)), // Manhattan College
      LocationKeyframeModel(
          GeoCoordinates(40.73603959180013, -73.98968489844603), const Duration(milliseconds: 6000)), // Union Square
      LocationKeyframeModel(
          GeoCoordinates(40.741732824650214, -73.98825255774022), const Duration(milliseconds: 5000)), // Flatiron
      LocationKeyframeModel(GeoCoordinates(40.74870637098952, -73.98515306630678),
          const Duration(milliseconds: 6000)), // Empire State Building
      LocationKeyframeModel(
          GeoCoordinates(40.742693509776856, -73.95937093336781), const Duration(milliseconds: 3000)), // Queens Midtown
      LocationKeyframeModel(GeoCoordinates(40.75065611103842, -73.96053139022635),
          const Duration(milliseconds: 4000)), // Roosevelt Island
      LocationKeyframeModel(
          GeoCoordinates(40.756823163883794, -73.95461519921352), const Duration(milliseconds: 4000)), // Queens Bridge
      LocationKeyframeModel(GeoCoordinates(40.763573707276784, -73.94571562970638),
          const Duration(milliseconds: 4000)), // Roosevelt Bridge
      LocationKeyframeModel(GeoCoordinates(40.773052036400294, -73.94027981305442),
          const Duration(milliseconds: 3000)), // Roosevelt Lighthouse
      LocationKeyframeModel(GeoCoordinates(40.78270548734745, -73.92189566092568),
          const Duration(milliseconds: 3000)), // Hell gate Bridge
      LocationKeyframeModel(
          GeoCoordinates(40.78406704306872, -73.91746017917936), const Duration(milliseconds: 2000)), // Ralph Park
      LocationKeyframeModel(
          GeoCoordinates(40.768075472169045, -73.97446921306035), const Duration(milliseconds: 2000)), // Wollman Rink
      LocationKeyframeModel(
          GeoCoordinates(40.78255966255712, -73.9586425508515), const Duration(milliseconds: 3000)), // Solomon Museum
      LocationKeyframeModel(GeoCoordinates(40.80253970834194, -73.93156255568137),
          const Duration(milliseconds: 3000)), // Vintage Autobody
      LocationKeyframeModel(GeoCoordinates(40.79780371121212, -73.92238900253808),
          const Duration(milliseconds: 4000)), // Robert Kennedy Bridge
      LocationKeyframeModel(GeoCoordinates(40.80771345637072, -73.93250541322794),
          const Duration(milliseconds: 3000)), // Third Avenue Bridge
      LocationKeyframeModel(GeoCoordinates(40.820213148574766, -73.94930111845413),
          const Duration(milliseconds: 3000)), // City College NYC
      LocationKeyframeModel(GeoCoordinates(40.84692287418771, -73.92803657908391),
          const Duration(milliseconds: 1500)), // Washington Bridge
      LocationKeyframeModel(GeoCoordinates(40.85851487236918, -73.91388539084845),
          const Duration(milliseconds: 2000)), // Hall of Fame for Americans
      LocationKeyframeModel(GeoCoordinates(40.87784894879347, -73.92238697760786),
          const Duration(milliseconds: 2000)), // Henry Hudson Bridge
      LocationKeyframeModel(GeoCoordinates(40.881034859141806, -73.920040015101),
          const Duration(milliseconds: 1500)), // Henry Hudson Park
      LocationKeyframeModel(GeoCoordinates(41.067415618493946, -73.86134115274218),
          const Duration(milliseconds: 1500)) // Transfiguration Church
    ]);
  ...
  List<ScalarKeyframeModel> _createScalarsForTripToNYC() {
    ...
    scalarList.add(ScalarKeyframeModel(8000000.0, const Duration(milliseconds: 4000)));
    scalarList.add(ScalarKeyframeModel(500.0, const Duration(milliseconds: 5000)));
