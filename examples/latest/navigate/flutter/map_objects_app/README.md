The MapObjects example app shows how to draw polylines, arrows, polygons and circles on the map. You can find how this is done in [MapObjectsExample.dart](lib/MapObjectsExample.dart).
