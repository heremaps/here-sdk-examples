...
struct ContentView: View {
    ...
    @State private var routingWithAvoidanceOptionsExample: RoutingWithAvoidanceOptionsExample?
    ...
    var body: some View {
             ...
             VStack {
                 HStack {
                     CustomButton(title: "Add route") {
                         routingWithAvoidanceOptionsExample?.addRoute()
                     }
                     CustomButton(title: "Clear map") {
                         routingWithAvoidanceOptionsExample?.clearMap()
                     }
                 }
             }
         }
         .onAppear {
             ...
             routingWithAvoidanceOptionsExample = RoutingWithAvoidanceOptionsExample(mapView)             
         }
     }
}
