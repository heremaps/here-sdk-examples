...
struct ContentView: View {
    ...
    @State private var customMapStylesExample: CustomMapStylesExample?
    ...
    var body: some View {
         ...
         ZStack(alignment: .top) {
             ...
             HStack {
                 CustomButton(title: "Load") {
                     customMapStylesExample?.onLoadButtonClicked()
                 }
                 CustomButton(title: "Unload") {
         ...
         .onAppear {
             ...
             customMapStylesExample = CustomMapStylesExample(mapView)
         }
     }
}
