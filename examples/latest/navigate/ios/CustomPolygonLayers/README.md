This example app shows how to load custom polygon layers. You can find how this is done in [CustomPolygonLayersExample.swift](CustomPolygonLayersExample/CustomPolygonLayersExample.swift).
