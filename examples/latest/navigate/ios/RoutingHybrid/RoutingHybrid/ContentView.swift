...
struct ContentView: View {
    ...
    @State private var routingHybridExample: RoutingHybridExample?
    ...
    var body: some View {
             ...
             VStack {
                 HStack {
                     CustomButton(title: "Add route") {
                         routingHybridExample?.addRoute()
                     }
                     CustomButton(title: "Add waypoints") {
                         routingHybridExample?.addWaypoints()
                     }
                     CustomButton(title: "Clear") {
                         routingHybridExample?.clearMap()
                     }
                 }
                 HStack {
                     CustomButton(title: "Switch online") {
                         routingHybridExample?.onSwitchOnlineButtonClicked()
                     }
         ...
         .onAppear {
             ...
             routingHybridExample = RoutingHybridExample(mapView)
         }
     }
}
