...
struct ContentView: View {
    ...
    @State private var positioningExample: PositioningExample?
    ...
    var body: some View {
         ...
         .onAppear {
             ...
             positioningExample = PositioningExample(mapView)
         }
         .onDisappear {
             // ContentView disappeared, release the PositioningExample instance.
             // This triggers calling deinit and thus, it will stop the LocationEngine.
             positioningExample = nil
         }
     }
}
