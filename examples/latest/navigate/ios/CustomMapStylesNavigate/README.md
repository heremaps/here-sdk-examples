This example app shows how to load custom maps. You can find how this is done in [CustomMapStylesExample.swift](CustomMapStylesExample/CustomMapStylesExample.swift).
