...
struct ContentView: View {
    ...
    @State private var rasterTileSourceExample: CustomRasterTileSourceExample?
    ...
    var body: some View {
             ...
             VStack {
                 HStack {
                     CustomButton(title: "Enable") {
                         rasterTileSourceExample?.onEnableButtonClicked()
                     }.padding(.trailing, 20)
                     CustomButton(title: "Disable") {
                         rasterTileSourceExample?.onDisableButtonClicked()
                     }.padding(.leading, 20)
                 }
             }
         }
         .onAppear {
             ...
             rasterTileSourceExample = CustomRasterTileSourceExample(mapView)
         }
     }
}
