...
> **Note:** The `EVSearchExample` class demonstrates how to use the HERE SDK's `EVSearchEngine` to query detailed EV charging location information. This feature requires an additional EVCP3 license, which is not included with the standard Navigation license.
