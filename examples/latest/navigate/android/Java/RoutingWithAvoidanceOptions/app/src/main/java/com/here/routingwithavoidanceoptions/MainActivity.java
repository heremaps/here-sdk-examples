...
public class MainActivity extends AppCompatActivity {
    ...
    private RoutingWithAvoidanceOptionExample routingWithAvoidanceOptionExample;
    ...
    private void loadMapScene() {
        mapView.getMapScene().loadScene(MapScheme.NORMAL_DAY, new MapScene.LoadSceneCallback() {
            ...
            public void onLoadScene(@Nullable MapError mapError) {
                if (mapError == null) {
                    routingWithAvoidanceOptionExample = new RoutingWithAvoidanceOptionExample(MainActivity.this, mapView);
                } else {
    ...
    public void addRouteButtonClicked(View view) {
        routingWithAvoidanceOptionExample.addRouteButtonClicked();
    }

    public void clearMapButtonClicked(View view) {
        routingWithAvoidanceOptionExample.clearMap();
    }
    ...
    private void disposeHERESDK() {
        if (routingWithAvoidanceOptionExample != null) {
            routingWithAvoidanceOptionExample.dispose();
        }
