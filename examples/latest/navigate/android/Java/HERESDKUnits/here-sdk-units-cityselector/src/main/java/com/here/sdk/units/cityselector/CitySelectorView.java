...
public class CitySelectorView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        citySelectorUnit = new CitySelectorUnit(button, context);
    }
}
