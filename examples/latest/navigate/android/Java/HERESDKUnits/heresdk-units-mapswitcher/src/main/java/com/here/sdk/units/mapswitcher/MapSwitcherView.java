...
public class MapSwitcherView extends LinearLayout {

    public MapSwitcherUnit mapSwitcherUnit;
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.heresdk_units_mapswitcher_button, this, true);
        ImageButton button = findViewById(R.id.mapswitcher_button_id);
        UnitAnimations.applyClickAnimation(button);
        mapSwitcherUnit = new MapSwitcherUnit(button);
    }
}
