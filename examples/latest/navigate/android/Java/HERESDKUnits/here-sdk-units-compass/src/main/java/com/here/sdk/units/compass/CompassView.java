...
public class CompassView extends LinearLayout {
    ...
    public CompassUnit compassUnit;
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.heresdk_units_compass_button, this, true);
        ImageButton button = findViewById(R.id.compass_button_id);
        UnitAnimations.applyClickAnimation(button);
        compassUnit = new CompassUnit(button);
    }
}
