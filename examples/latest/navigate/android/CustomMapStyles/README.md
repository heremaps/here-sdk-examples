This example app shows how to load custom maps. You can find how this is done in [CustomMapStylesExample.java](app/src/main/java/com/here/custommapstyles/CustomMapStylesExample.java).
