...
class CustomRasterLayersExample(
    ...
    private var outdoorLayer: MapLayer? = null
    private var outdoorDataSource: RasterDataSource? = null
    private var transportLayer: MapLayer? = null
    private var transportDataSource: RasterDataSource? = null
    ...
    private fun initializeRasterLayers() {
        ...
        val outdoorDataSourceName = "myRasterDataSourceStyleOutdoors"
        ...
        val transportDataSourceName = "myRasterDataSourceStyleTransport"
    ...
    private fun createRasterDataSourceWithTemplate(
        ...
        val path = "cache/raster/$dataSourceName"
    ...
    private fun createMapLayer(dataSourceName: String): MapLayer {
        ...
        val range = MapLayerVisibilityRange(MapCameraLimits.MIN_TILT, MapCameraLimits.MAX_ZOOM_LEVEL)
        try {
