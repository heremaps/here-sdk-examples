This example app shows how to load custom raster layers. You can find how this is done in [CustomRasterLayersExample.kt](app/src/main/java/com/here/sdk/customrasterlayers/CustomRasterLayersExample.kt).
