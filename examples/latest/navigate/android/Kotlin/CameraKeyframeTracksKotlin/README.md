The `CameraKeyframeTracksKotlin` example app shows how to use multiple keyframe tracks for map camera animations and how to animate to a route. You can find how this is done in [CameraKeyframeTracksExample.kt](app/src/main/java/com/here/camerakeyframetrackskotlin/CameraKeyframeTracksExample.kt).

**Note**: This is the same app as the "**CameraKeyframeTracks**" app, but implemented in Kotlin instead of Java.
