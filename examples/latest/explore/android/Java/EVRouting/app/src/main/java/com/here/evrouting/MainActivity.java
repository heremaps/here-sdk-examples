...
public class MainActivity extends AppCompatActivity {
    ...
    private EVRoutingExample evRoutingExample;
    ...
    private void loadMapScene() {
        mapView.getMapScene().loadScene(MapScheme.NORMAL_DAY, new MapScene.LoadSceneCallback() {
            ...
            public void onLoadScene(@Nullable MapError mapError) {
                if (mapError == null) {
                    evRoutingExample = new EVRoutingExample(MainActivity.this, mapView);
                } else {
    ...
    public void addEVRouteButtonClicked(View view) {
        evRoutingExample.addEVRouteButtonClicked();
    }

    public void onReachableAreaButtonClicked(View view) {
        evRoutingExample.onReachableAreaButtonClicked();
    }

    public void clearMapButtonClicked(View view) {
        evRoutingExample.clearMap();
    }
