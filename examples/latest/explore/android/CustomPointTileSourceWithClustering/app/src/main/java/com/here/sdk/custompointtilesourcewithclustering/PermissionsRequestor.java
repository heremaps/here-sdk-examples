...
public class PermissionsRequestor {
  ...
  public PermissionsRequestor(Activity activity) { this.activity = activity; }
        ...
        for (String permission : packageInfo.requestedPermissions) {
          if (ContextCompat.checkSelfPermission(activity, permission) !=
            ...
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.M &&
              ...
              // Exclude CHANGE_NETWORK_STATE as it does not require explicit
              // user approval. This workaround is needed for devices running
              // Android 6.0.0, see
