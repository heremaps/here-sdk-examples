...
Please do not forget: To run the app, you need to add your HERE SDK credentials to the `CameraApp.swift` file of your project. More information can be found in the _Get Started_ section of the _Developer Guide_.
