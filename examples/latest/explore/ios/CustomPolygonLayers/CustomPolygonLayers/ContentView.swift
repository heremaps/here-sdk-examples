...
struct ContentView: View {
    ...
    @State private var customPolygonLayersExample: CustomPolygonLayersExample?
    ...
    var body: some View {
         ...
         .onAppear {
             ...
             customPolygonLayersExample = CustomPolygonLayersExample(mapView)
         }
     }
}
