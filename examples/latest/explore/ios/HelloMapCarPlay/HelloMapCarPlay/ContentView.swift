...
struct ContentView: View {
    ...
    @State private var helloMapCarPlayExample: HelloMapCarPlayExample?
    ...
    var body: some View {
         ...
         ZStack(alignment: .top) {
             ...
             HStack {
                 CustomButton(title: "Zoom in +") {
                     helloMapCarPlayExample?.zoomIn()
                 }
                 CustomButton(title: "Zoom out -") {
                     helloMapCarPlayExample?.zoomOut()
                 }
             }
         }
         .onAppear {
