The HelloMapWithStoryboard example app shows how to build your UI from Xcode’s Interface builder using a storyboard. You can find how this is done in [ViewController.swift](HelloMapWithStoryboardLite/ViewController.swift).
