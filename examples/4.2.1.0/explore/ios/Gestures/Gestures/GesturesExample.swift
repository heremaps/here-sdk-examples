...
class GesturesExample: TapDelegate,
    ...
    init(viewController: UIViewController, mapView: MapView) {
        ...
        mapView.getGestures().tapDelegate = self
        mapView.getGestures().doubleTapDelegate = self
        mapView.getGestures().twoFingerTapDelegate = self
        mapView.getGestures().longPressDelegate = self
        ...
        mapView.getGestures().disableDefaultAction(forGesture: .doubleTap)
        mapView.getGestures().disableDefaultAction(forGesture: .twoFingerTap)
    ...
    private func removeGestureHandler(mapView: MapView) {
        // Stop listening.
        mapView.getGestures().tapDelegate = nil
        mapView.getGestures().doubleTapDelegate = nil
        mapView.getGestures().twoFingerTapDelegate = nil
        mapView.getGestures().longPressDelegate = nil
        ...
        mapView.getGestures().enableDefaultAction(forGesture: .doubleTap)
        mapView.getGestures().enableDefaultAction(forGesture: .twoFingerTap)
    }
