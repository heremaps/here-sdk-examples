...
class SearchExample: TapDelegate,
    ...
    // Completion handler for receiving auto suggestion results.
    ...
    public func geocodeAnAddress() {
        ...
        mapView.camera.lookAt(point: GeoCoordinates(latitude: 52.530932, longitude: 13.384915))
    ...
    private func createPoiMapMarker(geoCoordinates: GeoCoordinates) -> MapMarker {
        ...
        let mapMarker = MapMarker(at: geoCoordinates,
                                  resource: MapImage(pixelData: imageData,
