The MapOverlays example app shows how to pin a native UIView to the map. You can find how this is done in [MapOverlaysExample.swift](MapOverlays/MapOverlaysExample.swift).
